...
<center>
    <div class="container mt-4">
        ...
        <br>
        <form action="RegScript.php?<?= $_SERVER['QUERY_STRING'] ?>" method="post"
            ...
            if ($empl != "montage") {
                ...
                <input type="text" class="form-control" name="password" id="password" required
                       placeholder="Введите пароль (от 5 до 20 символов)" autocomplete="off">
                <br>
            <? } ?>
            ...
            <br>
            <button type="submit" class="btn btn-success">Добавить нового сотрудника в систему</button>
        </form>
