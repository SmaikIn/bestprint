...
//Автоматроцесса производства предприятия малого бизнеса (при помощи инф техн)изация п
//Использование СУБД для автоматизации производственных-процессов малого бизнеса


class Connect_to_DateBase {
  ...
  private function __construct() {
    $this->mysqli = new mysqli("127.0.0.1", "root1", "root1", "bestprint");
