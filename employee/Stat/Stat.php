        ...
        <div class="container mt-2">
            <center>
                ...
                <form method="get" action="Stat.php">
                    ...
                    <div class="row">
                        <div class="col">
                            <input class="form-control" type="date" value="<?=$dateStart?>" required name="dateStart"/>
                        </div>
                        <div class="col">
                            <input class="form-control" type="date" value="<?=$dateEnd?>" required name="dateEnd"/>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        <button type='submit' class="btn btn-success btn">Поиск</button>
                    </div>
                </form>
                <br>
                <form method="post" action="../employee.php?id=<?= $_GET['id'] ?>">
                    <div class="row">
                        <button type="submit" class="btn btn-danger btn-sm">Вернуться к просмотру сотрудников</button>
                    </div>
                </form>
                <br>
                <form method="post" target="_blank" action="Print.php?id=<?= $_GET['id'] ?>">
                    <input type="hidden" name="redact" value="<?=$_GET['redact']?>">
                    <input type="hidden" name="dateStart" value="<?=$_GET['dateStart']?>">
                    <input type="hidden" name="dateEnd" value="<?=$_GET['dateEnd']?>">
                    <div class="row">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="time">
                                            ...
                                            <input type="hidden" name="action" value="<?= $action = "redact" ?>">
                                    ...
                                    <div class="col">
                                        <button type="submit" class="btn btn-primary btn-sm" style="height: 35px">
