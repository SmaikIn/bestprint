        ...
        <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <input type="date" class="form-control" name="dateStart" value="<?= $dateStart ?>"
                               style="width: 200px; text-align: center;" disabled>
                    </div>
                    <div class="col">
                    ...
                    <div class="col">
                        <a class="btn btn-warning btn-sm" onClick="window.print()" style="width: 200px;">
            ...
            <div class="row">
                <center>
                    ...
                    ?>
                    <table class="table table-hover" style="text-align: center; width: 700px;">
                        <thead>
                        <tr>
                            <th>ФИО</th>
                            <th>Раб. часы</th>
