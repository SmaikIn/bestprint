        ...
        <form action="Script/Script_Form.php" method="post" enctype="multipart/form-data">
            ...
            <div class="name">
                <div class="row">
                    ...
                    <div class="col">
                        <input type="text" class="form-control" name="task" id="task" autocomplete= "off" value="Замеры"  disabled="disabled">
                    </div>
                </div>
                <br>
                <div class="row">
                ...
                <div class="row">
                    <div class="col">
                        <h5>Адрес места выполнения замеров</h5>
                    </div>
                    <div class="col">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <textarea class="form-control" name = "techtask" id = "techtask" required placeholder="Описание Технического Задания" autocomplete="off" rows = "3"></textarea>
                    </div>
                </div>
                <br>
                <div class="row">
