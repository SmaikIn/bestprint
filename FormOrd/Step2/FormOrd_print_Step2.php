...
<div class="container mt-1">
            ...
            <div class="btn-group" role="group" aria-label="Basic mixed styles example" style="width: 600px;">
                ...
                if ($_SESSION['block_print'] == "on") {
                    ...
                    <a class="btn btn-outline-danger btn-lg"
                       href="FormOrd_print_Step2.php?id=<?= $id ?>&block_print=off">Удалить
                        блок
                    ...
                    <a class="btn btn-outline-success btn-lg"
                       href="FormOrd_print_Step2.php?id=<?= $id ?>&block_print=on">Добавить
                        блок
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
    ...
    if ($_SESSION['block_print'] == "on") {
        ...
        <div class="row">
            <center>
                <form method="get" action="FormOrd_print_Step2.php">
        ...
        <div class="table">
            ...
            <table class="table table-hover">
                ...
                for ($i = 0; $i < $_SESSION['cnt_order_print']; $i++) {
                    ...
                    ?>
                    <form name="block_print" method="post" action="FormOrd_print_Step2.php?id=<?= $id ?>"
                        ...
                        <tr>
                            <td>
                                ...
                                <br>
                                <div class="container">
                                    <a href="FormOrd_print_Step2.php?id=<?= $id ?>&cnt_order_print=delete&order_num=<?= $i + 1 ?>"
                                        ...
                                        <div class="col">
                                            <div class="input-group" style="width: 200px; text-align: center; ">
                                                <a class="btn btn-outline-danger btn-sm" style="width: 200px;"
                                                   href="FormOrd_print_Step2.php?id=<?= $id ?>&file_ord=<?= $i + 1 ?>&file_num=all&file_type=print">
                                                    Удалить все
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            ...
                                            for ($l = 2; $l < count($scan_dir); $l++) {
                                                ...
                                                <div class="input-group input-group-sm"
                                                    ...
                                                    <a class="btn btn-outline-danger"
                                                       href="FormOrd_print_Step2.php?id=<?= $id ?>&file_ord=<?= $i + 1 ?>&file_num=<?= $l ?>&file_type=print">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                             fill="currentColor" class="bi bi-x-octagon-fill"
                                                             viewBox="0 0 16 16">
                                                            <path d="M11.46.146A.5.5 0 0 0 11.107 0H4.893a.5.5 0 0 0-.353.146L.146 4.54A.5.5 0 0 0 0 4.893v6.214a.5.5 0 0 0 .146.353l4.394 4.394a.5.5 0 0 0 .353.146h6.214a.5.5 0 0 0 .353-.146l4.394-4.394a.5.5 0 0 0 .146-.353V4.893a.5.5 0 0 0-.146-.353L11.46.146zm-6.106 4.5L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 1 1 .708-.708z"/>
